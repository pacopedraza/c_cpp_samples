/*
ptrsor.tc-Inputs a list of string from the keyboard
sorts them in ascending order or descending order, and then
...
void sort(char *p[], int n, int sort_type)
{
    ...
    // Initialize the pointer to point the proper comparison
